...
//Set Filters
    ...
    CAN1SetFilter(1, CAN_FILTER_SID(0x380) & CAN_RX_EID_DIS, CAN_FILTER_EID(00000));
    CAN1SetMask(0, CAN_MASK_SID(0x7FC) & CAN_MATCH_FILTER_TYPE, CAN_MASK_EID(00000));
    
    CAN1SetFilter(2, CAN_FILTER_SID(0x607) & CAN_RX_EID_DIS, CAN_FILTER_EID(00000));
...
//Set transmitter and receiver mode
    ...
    CAN1SetRXMode(1, CAN_RXFUL_CLEAR & CAN_BUF0_DBLBUFFER_DIS );
